...
class Controller:
    ...
    def changesystembrightness():
        ...
        # Assuming sbcontrol.get_brightness(display=0) returns a list of brightness levels
        
        # Calculate the average brightness level from the list
        current_brightness_lv = sum(brightness_list) / len(brightness_list) / 100.0
        ...
        sbcontrol.fade_brightness(int(100 * current_brightness_lv), start=brightness_list[0])
